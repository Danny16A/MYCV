...
if (isset($_POST['submit'])) {
    ...
    if(move_uploaded_file($_FILES['thumbnail']['tmp_name'], $target_path)) {  
         $thumbnail = '/admin/blog/post/' . $target_path;
    ...
    $sql = "INSERT INTO mycv.posts
            (title, description, content, thumbnail, author_id, category_id)
            VALUES('$title', '$description', '$content', '$thumbnail',$author_id,$category_id);
            ";
